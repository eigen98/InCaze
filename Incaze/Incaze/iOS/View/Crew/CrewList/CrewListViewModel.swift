...
class CrewListViewModel : ObservableObject{
    ...
    var crewList : [CrewModel] = [ CrewModel(id: "", crewName: "런린이만 기기링", leaderId: "ko_su", type: "모집중", users: [], limitMember: 20, memberCount: 5, minimumGrade: "Newbie", missionCondition: "없음")]
